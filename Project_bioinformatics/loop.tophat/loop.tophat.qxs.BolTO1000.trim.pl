...
print   "../tophat ../Bol_TO1000_CoGe  $sample\.1P $sample\.2P -o $sample\.out -p $CPU --mate-inner-dist $mit\n\n";
sleep (5);
system (" ../tophat ../Bol_TO1000_CoGe $sample\.1P $sample\.2P -p $CPU --mate-inner-dist $mit");
