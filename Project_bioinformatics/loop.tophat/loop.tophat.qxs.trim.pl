...
print   "../tophat ../bt2_base_Brapa_1.5  $sample\.1P $sample\.2P -o $sample\.out -p $CPU --mate-inner-dist $mit\n\n";
sleep (5);
system (" ../tophat ../bt2_base_Brapa_1.5 $sample\.1P $sample\.2P -p $CPU --mate-inner-dist $mit");
