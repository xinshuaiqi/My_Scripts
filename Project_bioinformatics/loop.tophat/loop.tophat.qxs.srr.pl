...
print   "../tophat ../bt2_base_Brapa_1.5  $sample\_1.clean $sample\_2.clean -o $sample\.out -p $CPU --mate-inner-dist $mit\n\n";
sleep (5);
system (" ../tophat ../bt2_base_Brapa_1.5 $sample\_1.clean $sample\_2.clean -o $sample\.out -p $CPU --mate-inner-dist $mit");
