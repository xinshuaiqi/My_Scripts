...
def paper_all_years(args_a,args_fy,args_ty):
    for i in range (0,args_ty-args_fy):
        ...
        #print(url)
        paper_a_year(args_a,y1,y2)




def url_generator(args_a,y1,y2):
    ...
    #    .format(args_a,args_fy,args_ty)+'\"'
    # url="https://scholar.google.com/scholar?as_q=plant+genome&as_epq=&as_oq=&as_eq=&as_occt=any&as_sauthors=&as_publication=&as_ylo=2008&as_yhi=2018&hl=en&as_sdt=0%2C26"
    url = "https://scholar.google.com/scholar?as_q={0}&as_epq=&as_oq=&as_eq=&as_occt=any&as_sauthors=&as_publication=&as_ylo={1}&as_yhi={2}&hl=en&as_sdt=0%2C26" \
    .format(args_a,y1,y2)    
    return url
    # print(url) 
    # use: url = url_generator(args_a,args_fy,args_ty)
...
def paper_a_year(args_a, y1,y2):   
    ...
    # pretend to access the website from iphone 
